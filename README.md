...
- Have Hector Quadrotor installed. (Install from https://github.com/RAFALAMAO/hector-quadrotor-noetic)
  - **NOTE**: For this project, a small modification was made to the quadrotor model in order to give it a red color. The required files have been uploaded into the quadrotor_ folder.
